...
public class ThemTieuDe extends JFrame implements ActionListener{
	...
	private void Buider() {
		...
		b8.add(btnThem = new JButton("Thêm tiêu đề", new ImageIcon("img/icon_themtieude.png")));
		...
		btnThem.setBackground(Color.darkGray);
		btnThem.setForeground(Color.CYAN);
